...
const About = () => {
    ...
    return <>
        ...
        <IconContext.Provider value={{ style: { verticalAlign: 'bottom' } }}><main className="w-full h-full bg-three text-one text-xl flex flex-col items-center justify-center text-center font-bold">
            <BackArrow />
